...
type Load =
        ...
        (id : string,
         ...
         remarks : string option ) =
                { ID = id
                  ...
                  Load1DistanceFt = load1DistanceFt
                  Load1DistanceIn = load1DistanceIn
                  Load2Value = load2Value
                  Load2DistanceFt = load2DistanceFt
                  Load2DistanceIn = load2DistanceIn
                  Ref = ref
                  LoadCases = loadCases
                  Remarks = remarks }
    ...
    static member Parse(loadDto : LoadDto) =
        ...
        { ID = id
          ...
          Load1DistanceIn = loadDto.Load1DistanceIn
